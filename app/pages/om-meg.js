module.exports = async function ($) {
    ...
    <div class="top-row">
      ...
      <div class="top-column text">
        <div class="top-text">
          ...
          <p>&ldquo; ${$.t('om_meg_undertittel_bilde')} &rdquo;</p>
        </div>
      </div>
    </div>
  </div>
  <div class="full-width border-row light-background">
    <div class="intro-om-meg inner-width">
      ...
      <blockquote>${$.t('om_meg_tekst4')}</blockquote>
      <blockquote>${$.t('om_meg_tekst5')}</blockquote>
      <blockquote>${$.t('om_meg_tekst6')}</blockquote>
      <blockquote>${$.t('om_meg_tekst7')}</blockquote>
      <blockquote>${$.t('om_meg_tekst8')}</blockquote>
      <blockquote>${$.t('om_meg_tekst9')}</blockquote>
