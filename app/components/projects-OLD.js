          ...
          <div class="slideshow-container">
            <div class="mySlides fade">
              ...
              <div class="text-slider">
                <h4>
                  <a href="https://asylet.no" target="_blank" rel="noopener"
                    >Kafé Asylet</a
                  >
                </h4>
              </div>
            ...
            <div class="mySlides fade">
              ...
              <div class="text-slider">
                <h4>
                  <a
                    href=" https://vdbautoshine.no"
                    target="_blank"
                    rel="noopener"
                    >VDB Autoshine nettbutikk</a
                  >
                </h4>
              </div>
            </div>
            ...
            <div class="mySlides fade">
              ...
              <div class="text-slider">
                <h4>
                  <a href="http://tabibito.no" target="_blank" rel="noopener"
                    >Tabibito Asian Fusion Restaurant</a
                  >
                </h4>
              </div>
            </div>
            ...
            <div class="mySlides fade">
              ...
              <div class="text-slider">
                <h4>
                  <a
                    href="https://crowdfundhq.com"
                    target="_blank"
                    rel="noopener"
                    >CrowdfundHQ - Create your own site</a
                  >
                </h4>
              </div>
            </div>
            ...
            <div class="mySlides fade">
              ...
              <div class="text-slider">
                <h4>
                  <a href="https://waveorb.com" target="_blank" rel="noopener"
                    >Waveorb - Personal, marketing and support emails</a
                  >
                </h4>
              </div>
            </div>
