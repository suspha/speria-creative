      ...
      <div class="contact-form inner-width-wide">
        <div class="row gutters">
          ...
          <div class="col col-8 contact" >
            ...
            <form action="${$.link(
              'index'
            )}" method="post" class="form" autocomplete="off" onsubmit="sendEmail(this); return false">
              <div class="row gutters">
                <div class="col col-6">
                  <div class="form-item">
                    <label for="input-name">${$.t(
                      'index_kontakt_form1'
              ...
              <div class="form-item">
                ...
                <textarea id="input-message" rows="6" name="message" placeholder="${$.t(
                  'index_kontakt_form_write'
